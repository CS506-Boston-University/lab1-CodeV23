...
class Sub:
    ...
    def __repr__(self):
        ...
        left_str = repr(self.p1)
        right_str = repr(self.p2)
...
class Div:
    ...
    def __repr__(self):
        ...
        if isinstance(self.p2, (Add, Sub, Mul, Div)):
            right_str = f"( {right_str} )"
        return f"{left_str} / {right_str}" #different repr for div and sub because the last one kept breaking
